...
const PopUp = (props: PopUpProps) => {
  return (
    <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 md:w-3/6 md:h-4/6 w-5/6 h-3/6 bg-bg-variant shadow-lg shadow-comment rounded p-2 whitespace-nowrap z-50 border border-bg-highlight">
